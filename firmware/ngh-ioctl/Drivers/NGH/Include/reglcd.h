...
const unsigned short _regValues[] = {
	...
	0x36, 1, 0x22, // Memory Access Control
	0x3A, 1, 0x70, // Interface Pixel Format (RGB 24 bit/pixel)
	0xB6, 1, 0xA2, // Display Function Control
	0xB0, 1, 0x00, // Interface Mode Control
	0x2A, 4, 0x00, 0x00, 0x03, 0x55, // Column Address Set (0 ~ 854-1)
	0x2B, 4, 0x00, 0x00, 0x01, 0xDF, // Page Address Set (0 ~ 480-1)
	0x11, 0, // Sleep Out
	LCD_DELAY, 120,
	0x29, 0, // Display ON
};
